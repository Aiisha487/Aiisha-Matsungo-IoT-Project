...
\end{enumerate}
% ============================================================================
% PHOTO INTEGRATION - ADD AFTER SECTION 1 (PROBLEM DEFINITION)
% ============================================================================

% Add this new section after Section 1, before Section 2
% Insert around line 50-60 (after the "Alternatives Considered" section)
...
\caption{\textbf{Snell Library 4th Floor Glass Study Room:} All-glass construction allows visual transparency but provides minimal acoustic isolation (estimated STC 26--28). Room surrounded by open corridor traffic and adjacent workspaces. Predicted baseline: 42--48~dBA despite ``quiet zone'' designation. This represents a \textit{poorly-placed} quiet zone where architectural decisions (glass walls for openness) conflict with acoustic requirements. System should detect elevated baseline and flag for facility management review.}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{silent_study_sign.jpg}
\caption{\textbf{Posted Signage Without Verification:} ``Silent Study'' sign at Snell Library glass room entrance. Sign requests compliance (``Please be respectful, No talking, Silence phones and devices'') but provides no real-time feedback on actual acoustic conditions. Users cannot determine if zone is \textit{currently} quiet before entering. Validates problem statement: facilities rely on signage alone with no enforcement or monitoring mechanism. Photo taken at blue-walled individual study room with glass door.}
\label{fig:sign}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{reflection_room.jpg}
